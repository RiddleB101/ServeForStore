...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户表（管理员）';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户访问记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='app错误日表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='第三方登录绑定关系';
...
(
    ...
    PRIMARY KEY (`id`),
    KEY `idx_prodcut_id_id` (`product_id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4 COMMENT ='商品销售情况';
...
(
    ...
    `product_id`   int(11)          NOT NULL DEFAULT '0' COMMENT '商品表id',
    `note`         text             NOT NULL COMMENT '备注信息',
